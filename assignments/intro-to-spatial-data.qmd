...
```{r}
ak_rgns_sf <- read_sf(
  here("data/processed/shapefile_demo_data/ak_regions_simp.shp")
)
```
...
pop_df <- read_csv(here("data/processed/shapefile_demo_data/alaska_population.csv"))
```
...
```{r}
write_sf(pop_rgn_3338_sf, here("data/processed/shapefile_demo_data/ak_regions_population.shp"))
```
...
```{r}
rivers_3338_sf <- read_sf(here("data/processed/shapefile_demo_data/ak_rivers_simp.shp"))
```
